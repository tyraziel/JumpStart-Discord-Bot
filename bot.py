...
listParser.add_argument('-s', '--set', choices=['ALL', 'JMP', 'J22', 'DMU', 'BRO', 'ONE', 'MOM', 'LTR', 'CLU', 'J25', 'FDN', 'TLA', 'TLB'], default='ALL', action='store')
...
pickParser.add_argument('-s', '--set', choices=['ALL', 'JMP', 'J22', 'DMU', 'BRO', 'ONE', 'MOM', 'LTR', 'CLU', 'J25', 'FDN', 'TLA', 'TLB'], default='JMP', action='store')
